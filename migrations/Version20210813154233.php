 ...
 */
final class Version20210813154233 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE permutation (id INT AUTO_INCREMENT NOT NULL, auteur_id INT DEFAULT NULL, interesse_id INT DEFAULT NULL, destination_id INT DEFAULT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', statut TINYINT(1) DEFAULT \'0\' NOT NULL, UNIQUE INDEX UNIQ_565560E760BB6FE6 (auteur_id), UNIQUE INDEX UNIQ_565560E7B41DC70D (interesse_id), INDEX IDX_565560E7816C6140 (destination_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
